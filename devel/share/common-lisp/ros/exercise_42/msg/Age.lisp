...
(cl:defmethod cl:initialize-instance :after ((m <Age>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Age)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise_42-msg:<Age> is deprecated: use exercise_42-msg:Age instead.")))

(cl:ensure-generic-function 'years-val :lambda-list '(m))
(cl:defmethod years-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise_42-msg:years-val is deprecated.  Use exercise_42-msg:years instead.")
  (years m))

(cl:ensure-generic-function 'months-val :lambda-list '(m))
(cl:defmethod months-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise_42-msg:months-val is deprecated.  Use exercise_42-msg:months instead.")
  (months m))

(cl:ensure-generic-function 'days-val :lambda-list '(m))
(cl:defmethod days-val ((m <Age>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exercise_42-msg:days-val is deprecated.  Use exercise_42-msg:days instead.")
  (days m))
